      ...
      <table className="w-full text-left text-sm whitespace-nowrap">
        <thead className="bg-gray-50 dark:bg-stone-900 border-b border-gray-200 dark:border-stone-700 text-stone-600 dark:text-stone-300">
          <tr>
            ...
            <th className="px-6 py-4 font-semibold">Resource Space</th>
            <th className="px-6 py-4 font-semibold text-right">Context</th>
          </tr>
        </thead>
        ...
        <tbody className="divide-y divide-gray-100 dark:divide-stone-700">
          {logs.map((log) => (
            <tr
              ...
              className="hover:bg-gray-50 dark:hover:bg-stone-800/80 transition-colors cursor-pointer"
            >
              ...
              <td className="px-6 py-4 text-right">
                <button className="text-indigo-600 dark:text-indigo-400 font-medium hover:underline flex items-center gap-1 justify-end w-full cursor-pointer">
                  <View />
                  Inspect
                </button>
              </td>
